        ...
        switch (this.currentScale) {
            ...
            default:
                ...
                for (let i = 0; i < elementRowPositions.length; ++i) {
                    this.currentShape.addCylinder(elementRowPositions[i], elementRowPositions[i].clone()
                        .add(this.structure.depthVector.clone()
                        .multiplyScalar(this.structure.elementDiamater * this.structure.depthInElements)), [1, i / elementRowPositions.length, 0], this.structure.elementDiamater * 0.5, "Element_row_" + i.toString());
                }
                break;
        }
