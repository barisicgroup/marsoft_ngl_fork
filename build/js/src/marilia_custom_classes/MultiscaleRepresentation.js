            ...
            default:
                ...
                for (let i = 0; i < elementRowPositions.length; ++i) {
                    this.currentShape.addCylinder(elementRowPositions[i], elementRowPositions[i].clone()
                        ...
                        .multiplyScalar(this.structure.elementDiameter * this.structure.depthInElements)), [1, i / elementRowPositions.length, 0], this.structure.elementDiameter * 0.5, "Element_row_" + i.toString());
                }
                break;
        }
